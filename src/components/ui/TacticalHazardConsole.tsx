        ...
        <div className="relative flex flex-col md:flex-row items-stretch gap-2">
          ...
          <div className="w-full md:w-36 flex flex-row md:flex-col items-center justify-between md:justify-start gap-1.5 p-1.5 bg-slate-50/70 border border-slate-200/70 rounded-xl shrink-0 font-mono text-[11px]">
            ...
            <button
              ...
              className={`flex-1 md:flex-none w-full flex items-center justify-center md:justify-start gap-2 px-3 py-2 rounded-lg transition-all cursor-pointer font-medium ${hazardMode === 'dual'
            ...
            <button
              ...
              className={`flex-1 md:flex-none w-full flex items-center justify-center md:justify-start gap-2 px-3 py-2 rounded-lg transition-all cursor-pointer font-medium ${hazardMode === 'seismic'
            ...
            <button
              ...
              className={`flex-1 md:flex-none w-full flex items-center justify-center md:justify-start gap-2 px-3 py-2 rounded-lg transition-all cursor-pointer font-medium ${hazardMode === 'wildfire'
              ...
              {visibleEvents.map((evt) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`rounded-full shadow-xs border transition-all ${isMajor
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative flex items-center justify-center p-0.5 rounded-full bg-white/95 border border-orange-400/80 shadow-xs hover:border-orange-600 hover:shadow-md transition-all">
                      <Flame
                        className={`transition-all ${isHighIntensity
